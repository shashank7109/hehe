...
const seedData = async () => {
  try {
    ...
    const cdcChairperson = await User.create({ name: 'CDC Chairperson', email: 'cdc@rgipt.ac.in', password, role: 'CDCChairperson' });
    ...
    console.log('----------------------------------------------------');
    console.log('Dummy Users provisioned successfully!');
